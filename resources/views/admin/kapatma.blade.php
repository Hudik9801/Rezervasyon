        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form role="form" action="{{route('admin_table_close_add')}}" method="post">
                        @csrf
                        <div>
                        ...
                        <div></div>
                        <div>
                            <select name="time_12" id="all">
                                <option >Select</option>
                                <option  id="12" value="1_2" >{{}}</option>
                                <option id="12_3" >12:30 PM</option>
                                <option id="1" >1:00 PM</option>
                                <option id="1_3" >1:30 PM</option>
                                <option id="2" >2:00 PM</option>
                                <option id="2_3" >2:30 PM</option>
                                <option id="3" >3:00 PM</option>
                                <option id="3_3" >3:30 PM</option>
                                <option id="4" >4:00 PM</option>
                                <option id="4_3" >4:30 PM</option>
                                <option id="5" >5:00 PM</option>
                                <option id="5_3" >5:30 PM</option>
                                <option id="6" >6:00 PM</option>
                                <option id="6_3" >6:30 PM</option>
                                <option id="7" >7:00 PM</option>
                                <option id="7_3" >7:30 PM</option>
                                <option id="8" >8:00 PM</option>
                                <option id="8_3" >8:30 PM</option>
                                <option id="9" >9:00 PM</option>
                                <option id="9_3" >9:30 PM</option>
